 ...
 */
public class NSS_RFC8141 extends NamespaceSpecificString {
    ...
    private static final Pattern allowedCharacters =
            Pattern.compile(String.format("^(%s)(%s|/|\\?)*$", pchar, pchar), CASE_INSENSITIVE);

    /**
     * Creates a new {@code NamespaceSpecificString} instance according to RFC 8141.
     *
    ...
    /**
     * Check if a given URL encoded NSS literal is valid according to RFC 8141.
     *
